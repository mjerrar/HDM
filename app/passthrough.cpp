...
PassThroughFilter::PassThroughFilter(float x_min_, float x_max_,
								float y_min_, float y_max_,
								float z_min_, float z_max_):pass_filter(){
...
*/
void PassThroughFilter::set_cutoffs(float x_min_, float x_max_,
								float y_min_, float y_max_,
...
void PassThroughFilter::get_cutoffs(){
	std::cout << "x:" << this->x_min << std::endl <<
	"y:" << this->y_min << std::endl <<
	"z:" << this->z_min << std::endl;
}
